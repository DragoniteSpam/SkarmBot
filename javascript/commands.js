	...
	*/
    ...
    ConfigParrot: {
        ...
        examples: [
            ...
            {command: "e@parrot meta scaling 0",          effect: "Sets the degree to which the size of the quote repo affects the probability that it will be drawn from when `everything` is called.\r\n0 -> everything weights are independent of size. 1 -> the more lines there are in a quote repo, the higher the probability that it will be drawn from (linearly growing share)\r\nCalling this command without the number will return the current value."},
            {command: "e@parrot meta weights",            effect: "Will list the weights for how the everything distribution is factored into the other repositories."},
            {command: "e@parrot meta weights skyrim 0.3", effect: "Will set the weight for the skyrim distribution to receive 0.3 shares of the distribution for every sum total of weights."},
        ],
        ignoreHidden: false,
        perms: Permissions.MOD,
        category: "administrative",
