...
module.exports = {
	...
	*/
    ...
    ConfigParrot: {
        ...
        examples: [
            {command: "e@cp nickname", effect: "Will list the current keywords that summon Skarm, along with their summoning odds. (Sub-alias: `e@cp nick`)"},
            ...
            {command: "e@cp skyrim add monahven 5", effect: "Will add \"monahven\" as one of Skarm's Skyrim keywords, with an activation rate of 5%. (Sub-alias: `e@cp sky`)"},
